...
function Terms() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-4 md:p-12 lg:p-20 font-sans flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl animate-float animate-delay-200" style={{ animationDelay: '3s' }}></div>
      ...
      <div className="max-w-3xl w-full glass-panel-dark bg-slate-950/80 border border-slate-800 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col relative z-10 animate-scale-up">
        ...
        <div className="p-8 md:p-12 bg-slate-950/40 text-white relative overflow-hidden border-b border-slate-850">
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/10 rounded-full -mr-32 -mt-32 opacity-50 blur-3xl"></div>
          ...
          <div className="text-center relative z-10 pt-4">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-blue-600/10 border border-blue-500/20 rounded-2xl mb-4">
        ...
        <div className="p-8 md:p-12 space-y-10">
          ...
          <section className="space-y-3 group">
            <div className="flex items-center gap-3.5 text-blue-400">
              <div className="w-9 h-9 bg-blue-600/10 border border-blue-500/20 rounded-xl flex items-center justify-center group-hover:bg-blue-600 group-hover:border-blue-500 group-hover:text-white transition-all duration-300">
                <Clock className="w-5 h-5" />
              </div>
              <h2 className="text-lg font-bold text-white tracking-tight">1. Introduction</h2>
            </div>
            <p className="text-slate-450 text-slate-400 leading-relaxed text-xs md:text-sm pl-12.5 pl-12">
              Welcome to the <span className="font-bold text-blue-400">OJT Tracker App</span>. By using our service and signing in with your Google account, you agree to comply with and be bound by the following terms and conditions. This app is designed solely for students to track their On-the-Job Training hours and tasks efficiently and professionally.
            </p>
          </section>
          ...
          <section className="space-y-3 group">
            ...
            <p className="text-slate-450 text-slate-400 leading-relaxed text-xs md:text-sm pl-12">
              We store your <span className="font-semibold text-slate-200">name, email address, and profile picture</span> retrieved from Google to personalize your experience. Your logged OJT records and uploaded documentary evidence are stored in our secure database and local storage. <span className="text-indigo-400 font-medium italic">We do not share your data with third parties.</span>
            </p>
          </section>
          ...
          <div className="flex flex-col items-center gap-4 pt-2">
            <button 
              onClick={() => navigate(-1)}
              className="group bg-gradient-to-r from-blue-600 to-indigo-650 hover:from-blue-700 hover:to-indigo-750 text-white font-extrabold text-[10px] uppercase tracking-widest py-4.5 px-12 rounded-2xl shadow-lg shadow-blue-500/10 hover:shadow-xl hover:shadow-blue-500/20 transition-all active:scale-95 flex items-center gap-2 cursor-pointer"
            >
              I Understand & Agree 
